...
| Area | What I Build |
|------|-------------|
| 🤖 Machine Learning | Time-series models, RL agents, anomaly detection, synthetic data generation |
| ⚙️ Backend Systems | Distributed pipelines, REST/WebSocket APIs, task queues, auth systems |
| 🗄️ Data Engineering | Real-time scraping, time-series DBs, price alerting, query optimization |
| ☁️ Cloud & Deployment | Containerized apps (Docker), cloud APIs (AWS, Azure), CI/CD-ready deployments |
